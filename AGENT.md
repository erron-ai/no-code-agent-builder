...
## Objective
Maintain `no-code-agent-builder` as a reliable, useful, and test-first project aligned with its primary promise:
> Visual web tool for non-technical users to assemble agents from components.
